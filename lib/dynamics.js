...
(function() {
  var Animation, Animations, Bezier, Dynamic, Dynamics, EaseInOut, Gravity, GravityWithForce, Linear, Loop, Matrix, SelfSpring, Spring, Vector, animationFrame, animationFrameApply, animationStart, browserSupportPrefixFor, browserSupportTransform, browserSupportWithPrefix, cacheFn, combineVector, convertToMatrix3d, css, decomposeMatrix, defaultForProperty, degProperties, getFirstFrame, hasCommonProperties, interpolateMatrix, keysForTransform, lengthVector, matrixToString, normalizeVector, parseFrames, pxProperties, recomposeMatrix, stopAnimationsForEl, transformProperties, transformStringToMatrixString, unitFor,
  ...
  Loop = {
    ...
    start: function() {
      Loop.running = true;
      return requestAnimationFrame(Loop.tick);
    },
    stop: function() {
    ...
    add: function(animation) {
      ...
      if (!Loop.running && Loop.animations.length > 0) {
        return Loop.start();
      }
    },
  ...
  pxProperties = ['marginTop', 'marginLeft', 'marginBottom', 'marginRight', 'paddingTop', 'paddingLeft', 'paddingBottom', 'paddingRight', 'top', 'left', 'bottom', 'right', 'translateX', 'translateY', 'translateZ'];

  degProperties = ['rotate', 'rotateX', 'rotateY', 'rotateZ', 'skew', 'skewX', 'skewY', 'skewZ'];

  transformProperties = ['translateX', 'translateY', 'translateZ', 'scale', 'scaleX', 'scaleY', 'scaleZ', 'rotate', 'rotateX', 'rotateY', 'rotateZ', 'skew', 'skewX', 'skewY', 'skewZ', 'perspective'];
